# Contributing to BX-bot JBehave
BX-bot JBehave is released under the [MIT](http://opensource.org/licenses/MIT) license. 
If you would like to contribute something, or simply want to hack the code, this document should 
help you get started.
 
## Reporting bugs and suggesting enhancements
If you find a bug, please submit an [issue](https://github.com/gazbert/bxbot-jbehave/issues). Try to 
...
Review the [issues list](https://github.com/gazbert/bxbot-jbehave/issues) and find something that 
...
To work on something, whether a new feature or a bug fix:
  ...
  ```
  git clone https://github.com/<your-id>/bxbot-jbehave.git
  ```
  3. Add the upstream repository as a remote: 
  ```
  git remote add upstream https://github.com/gazbert/bxbot-jbehave.git
  ```  
